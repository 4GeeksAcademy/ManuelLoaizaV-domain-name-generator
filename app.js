...
// The ending of my last two words intentionally are top level domains.
    ...
    for (let j = 0; j < adjectives.length; j++) {
        for (let k = 0; k < nouns.length; k++) {
            for (let l = 0; l < topLevelDomains.length; l++) {
                ...
                // TODO: Discover if there is simpler way to obtain a prefix specifying number of characters from the end I won't take.
